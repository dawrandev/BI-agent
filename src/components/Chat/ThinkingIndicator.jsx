...
const ThinkingIndicator = ({ steps = [], isAnalyzing = true }) => {
  // Agar hech qanday step yo'q va analyzing ham yo'q bo'lsa, hech narsa ko'rsatma
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.thinkingBox}>
        ...
        {steps.length > 0 && (
          <div style={styles.stepsList}>
            {steps.map((step, index) => (
              <div key={step.stepNumber || index} style={styles.stepRow}>
                ...
                <div style={styles.stepContent}>
                  ...
                  <span
                    style={
                      step.completed ? styles.completedText : styles.activeText
                    }
                  >
                    {step.text}
                  </span>
        ...
        {/* Loading dots if still analyzing but no steps yet */}
